...
import { 
  ...
  FiCalendar, FiFlag, FiEye, FiEdit2, FiTrendingUp,
...
const getStatusIcon = (status) => {
  const icons = {
    ...
    'In Progress': <FiTrendingUp className="w-3.5 h-3.5 text-blue-600" />,
...
function AdminProgressTask() {
  ...
  const fetchProgressTasks = useCallback(async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to load in-progress tasks');
    } finally {
      setLoading(false);
    }
  }, []);
          ...
          <div className="admin-dash__header flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="admin-dash__greeting flex items-center gap-2 text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                <FiTrendingUp className="w-7 h-7 text-indigo-600" /> In-Progress <span>Tasks</span>
              </h1>
              <p className="admin-dash__subtitle text-xs sm:text-sm text-slate-500 mt-1">
                Manage, review, and track all active in-progress tasks across your workforce.
              </p>
            </div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                title="Refresh In-Progress Tasks"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">routine active tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">standard active tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">important active tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">urgent active tasks</div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-xs">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="relative w-full sm:w-80">
                  ...
                  <input
                    type="text"
                    placeholder="Search active tasks by name or title..."
                    value={searchTerm}
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-slate-200 shadow-xs">
                ...
                <p className="mt-3 text-xs font-semibold text-slate-500">Loading in-progress tasks...</p>
              </div>
              ...
              <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 shadow-xs p-6">
                ...
                <h3 className="text-base font-bold text-slate-800">No in-progress tasks found</h3>
                <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto">
                  {searchTerm || filterPriority !== 'all'
                    ? 'No in-progress tasks matching your search filters.'
          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl border border-slate-200 animate-slideDown flex flex-col">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-800">In-Progress Task Details</h2>
