...
import { 
  ...
  FiCalendar, FiFlag, FiEye, FiEdit2,
  FiCheckCircle, FiX, FiFileText, FiPaperclip,
  FiStar, FiPlus, FiBarChart2, FiBell, FiChevronLeft, 
...
function AdminPendingTask() {
  ...
  const priorityCounts = {
    ...
    Critical: tasks.filter(t => t.status === 'Pending' && t.priority === 'Critical').length,
  };
          ...
          <div className="admin-dash__header flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="admin-dash__greeting flex items-center gap-2 text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                <FiClock className="w-7 h-7 text-indigo-600" /> Pending <span>Tasks</span>
              </h1>
              <p className="admin-dash__subtitle text-xs sm:text-sm text-slate-500 mt-1">
                Manage, review, and track all pending task assignments across your workforce.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div 
                ...
                className={`bg-white rounded-2xl p-5 border transition-all cursor-pointer shadow-xs hover:shadow-md ${
                  filterPriority === 'all' ? 'border-indigo-500 ring-2 ring-indigo-500/20' : 'border-slate-200 hover:border-slate-300'
                }`}
              >
                ...
                <div className="text-xs text-slate-400 mt-1">all pending tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">routine pending tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">standard pending tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">important pending tasks</div>
              </div>
              ...
              >
                ...
                <div className="text-xs text-slate-400 mt-1">urgent action required</div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-xs">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="relative w-full sm:w-80">
                  ...
                  <input
                    type="text"
                    placeholder="Search pending tasks by name or title..."
                    value={searchTerm}
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-slate-200 shadow-xs">
                ...
                <p className="mt-3 text-xs font-semibold text-slate-500">Loading pending tasks...</p>
              </div>
            ) : currentTasks.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 shadow-xs p-6">
                <div className="w-16 h-16 mx-auto bg-amber-50 rounded-2xl flex items-center justify-center mb-3">
                  <FiClock className="w-8 h-8 text-amber-500" />
                </div>
                <h3 className="text-base font-bold text-slate-800">No pending tasks found</h3>
                <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto">
                  {searchTerm || filterPriority !== 'all'
                    ? 'No pending tasks matching your search filters.'
                    : 'Great job! All pending tasks are cleared.'}
                </p>
              </div>
            ) : (
          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl border border-slate-200 animate-slideDown flex flex-col">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-800">Pending Task Details</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5">
                  ...
                  <p className="text-sm font-bold text-slate-800 mt-1">
                    {selectedTask.progress || 0}% · {selectedTask.submitDate ? new Date(selectedTask.submitDate).toLocaleDateString() : 'N/A'}
                  </p>
                </div>
              </div>
